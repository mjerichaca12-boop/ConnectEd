...
export function CoreModules() {
  ...
  return (
    <section id="features" className="relative w-full max-w-full bg-gradient-to-b from-gray-50 to-white py-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto">
          ...
          {modules.map((module, index) => {
            ...
            return (
              ...
              >
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${colors.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity`}></div>
                ...
                {/* Corner decoration */}
                <div className={`absolute top-4 right-4 w-20 h-20 bg-gradient-to-br ${colors.gradient} rounded-full opacity-0 group-hover:opacity-30 transition-opacity blur-2xl`}></div>
              </div>
            );
          })}
        </div>
        ...
        <div className="mt-16 bg-gradient-to-r from-emerald-600 via-emerald-500 to-blue-600 rounded-2xl p-8 md:p-12 text-center relative overflow-hidden">
          {/* Background Pattern */}
          <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff14_1px,transparent_1px),linear-gradient(to_bottom,#ffffff14_1px,transparent_1px)] bg-[size:3rem_3rem]"></div>
