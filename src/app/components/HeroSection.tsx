...
export function HeroSection() {
  ...
  return (
    <section id="hero" className="relative w-full max-w-full bg-gradient-to-br from-emerald-50 via-white to-blue-50 py-20 sm:py-32 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-emerald-100/10 to-blue-100/10 rounded-full blur-3xl"></div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          <div className="flex-1 relative">
            <div className="relative max-w-lg mx-auto">
                    ...
                    return (
                      <div 
                        ...
                        className={`flex items-center gap-3 p-3 rounded-lg bg-gradient-to-r ${
                          item.color === 'blue' ? 'from-blue-50 to-blue-50/50 border border-blue-100' :
                          item.color === 'red' ? 'from-red-50 to-red-50/50 border border-red-100' :
                          'from-emerald-50 to-emerald-50/50 border border-emerald-100'
                        } hover:shadow-md transition-all cursor-pointer transform hover:-translate-y-0.5`}
                        style={{ 
              ...
              {/* Floating Elements */}
              <div className="absolute -top-4 -right-4 w-20 h-20 bg-gradient-to-br from-emerald-400 to-emerald-600 rounded-2xl opacity-20 blur-xl animate-pulse"></div>
              <div className="absolute -bottom-4 -left-4 w-24 h-24 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl opacity-20 blur-xl animate-pulse delay-1000"></div>
            </div>
          </div>
        </div>
      </div>
