...
function Sidebar({ studentName, onLogout }) {
  ...
  const menuItems = [
    ...
    { icon: BookOpen,        label: "Subjects",         path: "/subjects",         color: "emerald" },
    { icon: GraduationCap,   label: "Grades",           path: "/grades",           color: "emerald" },
    ...
    { icon: MessageSquare,   label: "Messages",         path: "/messages",         color: "emerald" },
        ...
        <div className="px-5 py-5 border-b border-white/8 flex-shrink-0">
          ...
          <div className="flex items-center gap-3 bg-white/5 border border-white/8 rounded-xl px-3 py-2.5">
            ...
            <div className="flex-1 min-w-0">
              <p className="font-semibold text-white truncate text-sm">{studentName}</p>
              ...
              return (
                <Link
                  ...
                  className={`group flex items-center justify-between gap-3 px-3 py-2.5 rounded-xl transition-all duration-200 border cursor-pointer
                    ${active ? ac : "text-gray-400 hover:bg-white/5 border-transparent hover:text-white"}`}
                >
