...
export function UserRoles() {
  ...
  return (
    <section id="roles" className="relative w-full max-w-full bg-gradient-to-b from-gray-50 to-white py-20 px-4 sm:px-6 overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-20 right-1/4 w-80 h-80 bg-red-100/20 rounded-full blur-3xl"></div>
        <div className="absolute bottom-20 left-1/4 w-80 h-80 bg-emerald-100/20 rounded-full blur-3xl"></div>
      </div>
          ...
          {roles.map((role, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute -top-12 -right-12 w-40 h-40 bg-gradient-to-br from-white/50 to-transparent rounded-full"></div>
                ...
                {/* Bottom accent line */}
                <div className={`absolute bottom-0 left-0 right-0 h-1 ${colors.accentDot} transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300`}></div>
              </div>
            );
          })}
        </div>
