...
function HowItWorks() {
  ...
  return <section id="how-it-works" className="relative w-full max-w-full bg-white py-20 px-4 sm:px-6 overflow-hidden">
      {
    ...
    >
      ...
      /* Background gradient on hover */
                ...
                <div className={`absolute inset-0 ${colors.bg} opacity-0 group-hover:opacity-30 transition-opacity rounded-2xl`} />
      ...
      /* Corner accent */
                ...
                <div className={`absolute -top-10 -right-10 w-40 h-40 ${colors.bg} rounded-full opacity-0 group-hover:opacity-50 transition-opacity blur-2xl`} />
              </div>;
  })}
        </div>
    ...
    /* Background decoration */
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-emerald-50 via-blue-50 to-red-50 rounded-3xl transform -rotate-1" />
    ...
    const iconBgClass = stat.color === "emerald" ? "bg-emerald-100" : stat.color === "blue" ? "bg-blue-100" : "bg-red-100";
    const iconColorClass = stat.color === "emerald" ? "text-emerald-600" : stat.color === "blue" ? "text-blue-600" : "text-red-600";
    return <div
      key={index}
    ...
    >
                    ...
                    <div className={`text-3xl md:text-4xl font-bold mb-2 ${stat.color === "emerald" ? "text-emerald-600" : stat.color === "blue" ? "text-blue-600" : "text-red-600"}`}>
                      {stat.value}
                    </div>
