...
import { ChevronLeft, ChevronRight, X, Sparkles, CheckCircle2, Command, Loader2 } from "lucide-react";
    ...
    >
      ...
      >
        ...
        <div className="p-6">
          ...
          <p id="tour-step-description" className="text-gray-600 text-xs leading-relaxed mb-5 whitespace-pre-line">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-100">
            ...
            <div className="flex items-center gap-2">
              ...
              {isFinalStep ? (
                <button
                  onClick={finishTour}
                  className="px-5 py-2.5 bg-gradient-to-r from-green-600 to-teal-600 text-white font-semibold rounded-xl hover:from-green-700 hover:to-teal-700 active:scale-[0.98] shadow-md shadow-green-600/20 transition-all text-xs flex items-center gap-1.5"
                >
