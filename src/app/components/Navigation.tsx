...
export function Navigation() {
  ...
  return (
    <nav className={`w-full bg-white border-b sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center relative group">
            ...
            {clickCount > 0 && clickCount < 5 && (
              <span className="absolute -top-1 -right-1 w-4 h-4 bg-emerald-600 text-white text-xs rounded-full flex items-center justify-center animate-ping">
                {clickCount}
              </span>
            )}
          </div>
