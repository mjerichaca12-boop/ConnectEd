...
export function Sidebar({ studentName, onLogout }: SidebarProps) {
  ...
  return (
    <>
      ...
      >
        {/* Logo Section */}
        <div className="p-6 bg-gradient-to-br from-emerald-600 to-emerald-700 relative overflow-hidden">
          {/* Decorative circles */}
          ...
          <div className="relative">
            ...
            <p className="text-emerald-100 text-sm font-medium">Student Portal</p>
          </div>
        </div>
