...
function Profile() {
  ...
  const handlePasswordChange = () => {
    ...
    setTimeout(() => setShowPasswordSuccess(false), 3e3);
  };
  if (loading) {
  ...
  >
    ...
    /* Error Alert */
                ...
                {profileErrors.length > 0 && <div className="p-4 bg-red-50 border border-red-200 rounded-lg">
                    <div className="flex items-start gap-3">
                      <AlertCircle className="w-5 h-5 text-red-600 flex-shrink-0 mt-0.5" />
                      <div>
                        <p className="text-sm font-medium text-red-800 mb-1">Please fix the following errors:</p>
                        <ul className="list-disc list-inside text-sm text-red-700 space-y-1">
                          {profileErrors.map((error, index) => <li key={index}>{error.message}</li>)}
                        </ul>
                      </div>
                    </div>
                  </div>}
    ...
    /* Contact Number - Editable */
                ...
                <div>
                  ...
                  {isEditing ? <div className="flex items-center gap-3 px-4 py-3 border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-transparent">
  ...
  />
    ...
    /* Address - Editable */
                ...
                <div>
                  ...
                  {isEditing ? <div className="flex items-start gap-3 px-4 py-3 border border-gray-300 rounded-lg focus-within:ring-2 focus-within:ring-emerald-500 focus-within:border-transparent">
  ...
  />
                    </div> : <div className="flex items-start gap-3 px-4 py-3 bg-gray-50 rounded-lg border border-gray-200">
                      <MapPin className="w-5 h-5 text-gray-400 mt-0.5" />
  ...
  >
    ...
    /* Change Password Modal */
          ...
          {isChangingPassword && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
  ...
  >
                ...
                <div className="p-6 space-y-4">
                  {passwordErrors.length > 0 && <div className="p-3 bg-red-50 border border-red-200 rounded-lg">
                      <ul className="list-disc list-inside text-sm text-red-700 space-y-1">
  ...
  >
    ...
    /* Success Message */
          ...
          {showSuccessMessage && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
              <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
  ...
  >
    ...
    /* Password Success Message */
          ...
          {showPasswordSuccess && <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
              <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
                <div className="p-6 border-b border-gray-200">
                  <div className="flex items-center justify-between">
                    <h3 className="text-xl font-semibold text-gray-900">Success</h3>
