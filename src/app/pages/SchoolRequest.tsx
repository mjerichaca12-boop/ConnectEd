...
import { ArrowLeft, Building2, MapPin, Mail, User, Phone, Send, CheckCircle } from 'lucide-react';

export function SchoolRequest() {
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="text-center">
            ...
            <div className="w-16 h-1 bg-emerald-600 mx-auto rounded-full mb-8"></div>
