...
export function Announcements() {
  ...
  const filteredAnnouncements = announcements.filter(announcement => {
    ...
    const matchesFilter = 
      selectedFilter === 'all' ||
      (selectedFilter === 'school-wide' && announcement.targetAudience === 'School-wide') ||
      (selectedFilter === 'subject-specific' && announcement.targetAudience === 'Subject-specific') ||
              ...
              <div className="bg-white rounded-xl p-3 border border-gray-200 shadow-sm">
                ...
                <div className="space-y-1">
                  ...
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-colors ${
                      selectedFilter === 'subject-specific' 
                        ? 'bg-emerald-50 text-emerald-700 font-medium' 
                        : 'text-gray-700 hover:bg-gray-50'
                    }`}
                  >
                ...
                <div className="bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
                  ...
                  <div className="bg-gradient-to-r from-emerald-50 to-teal-50 p-6 border-b border-gray-200">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-sm">
                      ...
                      <div className="flex items-center gap-2">
                        {selectedAnnouncement.targetAudience === 'School-wide' ? (
