            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide">
              {allTeachers.length === 0 ? (
                <div className="py-12 text-center">
                  ...
                  <p className="text-xs text-gray-600 mt-1">Teachers must be registered first.</p>
                </div>
                ...
                <div className="divide-y divide-white/5">
                  {filteredRecipients.map((teacher) => {
                    ...
                    return (
                      ...
                      >
                        <div className="w-10 h-10 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-gray-900 font-bold text-sm flex-shrink-0">
