...
export function SubjectManagement() {
  ...
  const [subjectFormData, setSubjectFormData] = useState<SubjectFormData>({ code: '', name: '', description: '', credits: '', teacher: '', schedule: '', capacity: '' });
  const [formErrors, setFormErrors] = useState<FormErrors>({});
  const [editFormData, setEditFormData] = useState<SubjectFormData>({ code: '', name: '', description: '', credits: '', teacher: '', schedule: '', capacity: '' });
  ...
  const handleViewSubject = (subject: Subject) => { setSelectedSubject(subject); setShowViewModal(true); };
  ...
  const handleDeleteSubject = (subject: Subject) => { setSubjectToDelete(subject); setShowDeleteConfirm(true); };
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl max-w-md w-full shadow-2xl">
            ...
            <div className="px-6 pb-6 flex gap-3">
              <button onClick={() => { setShowDeleteConfirm(false); setSubjectToDelete(null); }} className="flex-1 px-4 py-3 text-gray-700 border border-gray-300 hover:bg-gray-50 rounded-lg transition-colors font-medium">Cancel</button>
