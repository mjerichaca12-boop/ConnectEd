...
function Grades() {
  ...
  return <div className="min-h-screen bg-gray-50 flex">
    ...
    options={[
      ...
      { value: "quarter1", label: "Quarter 1", icon: <CheckCircle className="w-5 h-5 text-blue-500" /> },
      { value: "quarter2", label: "Quarter 2", icon: <CheckCircle className="w-5 h-5 text-cyan-500" /> },
      { value: "quarter3", label: "Quarter 3", icon: <CheckCircle className="w-5 h-5 text-teal-500" /> },
      { value: "quarter4", label: "Quarter 4", icon: <Target className="w-5 h-5 text-emerald-500" /> },
