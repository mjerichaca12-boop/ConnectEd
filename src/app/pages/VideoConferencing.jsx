  ...
  if (isInMeeting) {
      ...
      /* Meeting Header */
        ...
        <div className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h2 className="text-gray-900 font-semibold">Mathematics - Algebra Basics</h2>
    ...
    >
      ...
      /* Teacher Video - Main */
              ...
              <div className="bg-white border border-gray-200 rounded-xl overflow-hidden relative h-[60%]">
                <div className="h-full bg-gradient-to-br from-green-500 to-teal-600 flex items-center justify-center">
                ...
                <div className="absolute bottom-3 left-3 right-3 flex items-center justify-between">
                  <div className="flex items-center gap-2 px-3 py-1.5 bg-gray-900/80 backdrop-blur-sm rounded-lg">
                    ...
                    <span className="px-2 py-0.5 bg-green-600 text-white text-xs rounded-full">Teacher</span>
                  </div>
