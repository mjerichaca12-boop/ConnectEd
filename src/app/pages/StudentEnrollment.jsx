...
function StudentEnrollment() {
  ...
  const getStatusBadge = (status) => {
    switch (status) {
      case "approved":
        return <span className="inline-flex items-center gap-1 px-4 py-2 bg-green-100 text-green-700 font-medium rounded-full">
            <CheckCircle className="w-4 h-4" />
            Approved
          </span>;
      case "rejected":
        return <span className="inline-flex items-center gap-1 px-4 py-2 bg-red-100 text-red-700 font-medium rounded-full">
            <AlertCircle className="w-4 h-4" />
            Rejected
          </span>;
      default:
        return <span className="inline-flex items-center gap-1 px-4 py-2 bg-blue-100 text-blue-700 font-medium rounded-full">
  ...
  return <div className="min-h-screen bg-gray-50 flex relative overflow-hidden">
    ...
    /* Birth Certificate */
                  ...
                  <div>
                    ...
                    {uploadedFiles.birthCertificate ? <div className="border-2 border-emerald-500 bg-emerald-50 rounded-xl p-4 flex items-center justify-between group transition-all">
                      ...
                      </div> : <label className="border-2 border-dashed border-gray-200 rounded-xl p-8 text-center hover:border-emerald-500 hover:bg-emerald-50/30 transition-all cursor-pointer block group">
    ...
    /* Report Card */
                  ...
                  <div>
                    ...
                    {uploadedFiles.reportCard ? <div className="border-2 border-emerald-500 bg-emerald-50 rounded-xl p-4 flex items-center justify-between group transition-all">
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-emerald-100 rounded-lg">
                            <FileText className="w-6 h-6 text-emerald-600" />
                          </div>
  ...
  >
    ...
    /* Status Card */
              ...
              {enrollmentRequest && <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 rounded-full ${enrollmentRequest.status === "pending" ? "bg-blue-500" : "bg-emerald-500"}`} />
                      <p className="text-sm text-gray-700">Documents Received</p>
                    </div>
                    <div className="flex items-center gap-3">
                      <div className={`w-2 h-2 rounded-full ${enrollmentRequest.status === "pending" ? "bg-gray-300" : "bg-emerald-500"}`} />
  ...
  >
    ...
    /* Birth Certificate */
              ...
              <div>
                ...
                {uploadedFiles.birthCertificate ? <div className="border-2 border-emerald-500 bg-emerald-50 rounded-lg p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
  ...
  >
                  ...
                  </div> : <label className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-emerald-500 transition-colors cursor-pointer block">
                    <input
    type="file"
  ...
  />
    ...
    /* Report Card */
              ...
              <div>
                ...
                {uploadedFiles.reportCard ? <div className="border-2 border-emerald-500 bg-emerald-50 rounded-lg p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <FileText className="w-8 h-8 text-emerald-600" />
                      <div>
  ...
  />
    ...
    /* ID Photo */
              ...
              <div>
                ...
                {uploadedFiles.idPhoto ? <div className="border-2 border-emerald-500 bg-emerald-50 rounded-lg p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <FileText className="w-8 h-8 text-emerald-600" />
                      <div>
