...
export function Messages() {
  ...
  // Example dummy conversations
  const [conversations, setConversations] = useState([
    {
      id: "c1",
      participantName: "Mr. Santos (Math)",
      participantRole: "Teacher",
      lastMessage: "Don't forget the assignment due tomorrow.",
      lastMessageTime: new Date(Date.now() - 3600000).toISOString(),
      unreadCount: 2,
      messages: [
        { id: "m1", senderId: "other", content: "Don't forget the assignment due tomorrow.", timestamp: new Date(Date.now() - 3600000).toISOString(), isOwn: false }
      ]
    },
    {
      id: "c2",
      ...
      lastMessage: "Your enrollment status has been updated.",
      lastMessageTime: new Date(Date.now() - 86400000).toISOString(),
      unreadCount: 0,
      messages: [
        { id: "m2", senderId: "other", content: "Your enrollment status has been updated.", timestamp: new Date(Date.now() - 86400000).toISOString(), isOwn: false }
      ]
    }
  ]);
