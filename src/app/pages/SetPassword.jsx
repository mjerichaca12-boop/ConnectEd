      ...
      <div className="w-full max-w-lg bg-white border border-gray-100 rounded-2xl p-8 shadow-xl">
        ...
        <div className="flex items-start gap-4 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Create a secure password for your ConnectEd account</p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-gray-50 border border-gray-200 text-gray-900 placeholder-gray-400 pl-11 pr-12 py-3 rounded-xl focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500 transition-all text-sm"
              />
              <button
                type="button"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 disabled:bg-green-800 disabled:cursor-not-allowed text-white font-semibold py-3.5 rounded-xl transition-all shadow-lg shadow-green-600/20 text-sm mt-6"
          >
            {loading ? (
              <>
        ...
        <p className="text-gray-600 text-xs text-center mt-6 pt-6 border-t border-gray-200">
          Don't have an invitation? <Link to="/request-access" className="text-green-600 hover:text-green-700 font-semibold">Request access here</Link>
        </p>
      </div>
    </div>
  );
